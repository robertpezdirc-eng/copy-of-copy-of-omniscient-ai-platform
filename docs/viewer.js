(() => {
  ...
  async function loadManifest(url) {
    try {
      ...
      console.error(err);
      setStatus(`Napaka pri manifestu: ${err.message}`, true);
    }
  }
  ...
  try {
    manifestInput.value = "https://raw.githubusercontent.com/robertpezdirc-eng/copy-of-copy-of-omniscient-ai-platform/feat/20-dashboards/dashboards/manifest.json";
