...
const initialCategories: DashboardCategory[] = [
  ...
  },
  {
    ...
    name: 'Workspace',
    dashboards: [
      { id: 'ws-finance', name: 'Finance', url: '/finance' },
      { id: 'ws-analytics', name: 'Analytics', url: '/analytics' },
  ...
  {
    id: 'ai-builder',
    name: 'AI Builder Dashboards',
    dashboards: [
      { id: 'db-1', name: 'Revenue Analytics', url: '/module/revenue-analytics' },
      { id: 'db-2', name: 'User Analytics & Engagement', url: '/module/user-analytics' },
      { id: 'db-3', name: 'AI Performance & Model Insights', url: '/module/ai-performance' },
      { id: 'db-4', name: 'Subscription Metrics', url: '/module/subscription-metrics' },
      { id: 'db-5', name: 'System Health Monitoring', url: '/module/system-health' },
      { id: 'db-6', name: 'Security & Authentication', url: '/module/security-auth' },
      { id: 'db-7', name: 'Affiliate Tracking', url: '/module/affiliate-tracking' },
      { id: 'db-8', name: 'Marketplace', url: '/module/marketplace' },
      { id: 'db-9', name: 'Churn Prediction', url: '/module/churn-prediction' },
      { id: 'db-10', name: 'Forecast', url: '/module/forecast' },
      { id: 'db-11', name: 'Sentiment Analysis', url: '/module/sentiment-analysis' },
      { id: 'db-12', name: 'Anomaly Detection', url: '/module/anomaly-detection' },
      { id: 'db-13', name: 'Payment Gateway', url: '/module/payment-gateway' },
      { id: 'db-14', name: 'API Usage', url: '/module/api-usage' },
      { id: 'db-15', name: 'Growth Engine', url: '/module/growth-engine' },
      { id: 'db-16', name: 'Gamification', url: '/module/gamification' },
      { id: 'db-17', name: 'Recommendations', url: '/module/recommendations' },
      { id: 'db-18', name: 'Neo4j Graph', url: '/module/neo4j-graph' },
      { id: 'db-19', name: 'Swarm Intelligence', url: '/module/swarm-intelligence' },
      { id: 'db-20', name: 'AGI Dashboard', url: '/module/agi-dashboard' },
    ],
  },
]
